...
const TOKEN_CONTRACT_ADDRESS = "0xfac5775552fC18B50B405872A78fD31b9e7735E9"
const MARKETPLACE_CONTRACT_ADDRESS = "0x805849d37e0e6ee0eD810c414849cbc48A2e20BF"
const TOKEN_CONTRACT_JSON_PATH = "./contracts/NFTcontract.json"
const MARKETPLACE_CONTRACT_JSON_PATH = "./contracts/Marketplace.json"
var token_contract
...
async function loadDapp() {
    ...
    document.getElementById("web3_message").textContent = "Loading..."
    var awaitWeb3 = async function() {
        ...
        web3.eth.net.getId((err, netId) => {
            if (netId == NETWORK_ID) {
                ...
                document.getElementById("web3_message").textContent = "Please connect to Mumbai";
            }
        });
    };
    awaitWeb3();
...
function insertMyTokenHTML(nft_id) {
    ...
    token_element.innerHTML = "Poninis #" + nft_id
...
async function insertMyListingHTML(listing_id) {
    ...
    //Token number text
    var token_element = document.createElement("p")
    token_element.innerHTML = "Poninis #" + listing.token_id + " (price: " + web3.utils.fromWei(listing.price) + ")"
...
async function insertActiveListingHTML(listing_id) {
    ...
    //Token number text
    var token_element = document.createElement("p")
    token_element.innerHTML = "Poninis #" + listing.token_id + " (Cost: " + web3.utils.fromWei(listing.price) + ")"
